...
FROM Employees
WHERE SALARY <= 10000 AND SALARY >= 15000 OR DEPARTMENT_ID= 30 OR DEPARTMENT_ID= 100;
...
FROM Employees
WHERE SALARY != 4500 AND SALARY != 10000 AND SALARY != 15000 AND JOB_ID= 'IT_PROG' OR JOB_ID= 'SH_CLERK';
...
SELECT FIRST_NAME, LAST_NAME
FROM Employees
WHERE (SELECT CHAR_LENGTH(LAST_NAME)= 6 FROM Employees);
